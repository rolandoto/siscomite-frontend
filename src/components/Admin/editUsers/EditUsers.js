...
class EditUsers extends Component {
    ...
    eHandleTriggerEditUser = (e) => {
        ...
        this.props.passwordApendris(pas)
    };

    render() {
        const { searchUsersReducer, searchedUserReducer, editUserSearchReducer,chagePasswordReducer,updatePassword } = this.props;
        console.log(chagePasswordReducer)
                            ...
                            {this.state.showModalEditUser && searchedUserReducer.status && (
                                <div className="modal_overlay_role min_height min_height_mobile">
                                    ...
                                    <div className="form_desing_edit">
                                        ...
                                        <form  onSubmit={this.eHandleTriggerEditUser}>
                                            <input
                                                type="hidden"
                                                className="form_control"
                                                placeholder="Nombre"
...
function mapStateToProps(state) {
    const { authReducer, searchUsersReducer,chagePasswordReducer, searchedUserReducer, editUserSearchReducer } = state;
    return { authReducer, searchUsersReducer, chagePasswordReducer,searchedUserReducer, editUserSearchReducer };
